<template>
  <div class="topBar row p-0 m-0">
    <div class="col col-4">
      ...
      /></span> -->
      <span class="appTitle appTitle_large pointer" @click="$router.push('/dashboard')"><span class="main">GENERAL</span>
        <span class="sub">HRM</span></span>
    ...
    <div class="col col-4 center p-0 m-0">
      <span class="appTitle appTitle_small pointer" @click="$router.push('/dashboard')"><span class="main">GENERAL</span>
        <span class="sub">HRM</span></span>
    </div>
    <div class="col col-4">
      <div class="topBarSmallViewOptions ps-2 pe-2">
        <span>
          <font-awesome-icon class="icon" icon="fa-home" @click="$router.push('/dashboard')" /></span>
        <span><font-awesome-icon class="icon me-3" :icon="userTheme == 'light-theme' ? 'fa-moon' : 'fa-sun'"
            @click="setTheme" /></span>
      </div>
      <div class="topBarLargeViewOptions">
        <div class="dropdown float-end">
          ...
          <ul class="dropdown-menu"
            :class="{ 'dropdown-menu-dark': user.theme == 'dark-theme', 'dropdown-menu-light': user.theme == 'light-theme' }"
            aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="#"><span><span><font-awesome-icon class="icon me-2"
                      icon="fa-gear" /></span><span> Preferences</span></span></a></li>
            <li><a class="dropdown-item" href="#"><font-awesome-icon class="icon me-2" icon="fa-lock" /> Security</a></li>
            <li><a class="dropdown-item" href="#" @click="this.$store.dispatch('logout')"><font-awesome-icon
                  class="icon me-2" icon="fa-power-off" />
                Logout</a></li>
          </ul>
        </div>
        <!-- <span>
